...
export default class Register extends Component {
  ...
  handleSubmit(event) {
    ...
    const { username, phone, address, email, password, password_confirmation} = this.state;

    axios
        .post('http://localhost:8082/buyers/add', 
            {
                "name":username,
                "phone": phone,
                "address": address,
  ...
  render() {
    return (
      <div className="container" style={{}}>
        <Link to="/buyer-login" className="btn btn-outline-warning float-right">
                  Login
        </Link>
        <br/><br/><br/><br/>
